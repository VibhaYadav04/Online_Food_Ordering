...
public class IngredientController {
	...
	// GET ALL INGREDIENT OF ANY RESTAURANT
	...
	// GET ALL CATEGORY OF ANY RESTAURANT
	@GetMapping("/restaurant/{id}/category")
	public ResponseEntity<List<IngredientCategory>> getRestaurantIngredientCategory(@PathVariable Long id)
			throws Exception {
		List<IngredientCategory> items = ingredientsService.findIngridientCategoryByRestaurant(id);
		return new ResponseEntity<>(items, HttpStatus.OK);
	}
