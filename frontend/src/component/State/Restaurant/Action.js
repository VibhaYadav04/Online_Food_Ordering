...
export const createEventAction = ({ data, jwt, restaurantId }) => {
    ...
    return async (dispatch) => {
        ...
        try{
            const response = await api.post(`/api/admin/restaurants/${restaurantId}`,data,{
                headers:{
                    Authorization: `Bearer ${jwt}`,
                },
            });
            console.log("Create restaurant event ", response.data);
...
export const getRestaurantsEvents = ({restaurantId, jwt}) => {
    return async (dispatch) => {
        ...
        try{
            ...
            console.log("Get all restaurants events ", response.data);
