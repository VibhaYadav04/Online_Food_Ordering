    ...
    <div className='min-h-screen px-5'>
      <div className='flex flex-col items-center justify-center h-[90vh]'>
        <Card className='box w-full lg:w-1/4 flex flex-col items-center rounded-md p-5'>
          ...
          <p className='py-3 text-center text-gray-300'>Thanks for choosing our Restaurant.</p>
          <p className='py-2 text-center text-gray-300 text-lg'>Hope you will love it !!</p>
